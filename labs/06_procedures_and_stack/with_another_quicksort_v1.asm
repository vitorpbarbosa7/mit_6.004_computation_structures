...
loop:	ADDC(R9, 1, R9)
		...
		LD(R13, R22, R13) // temp value in the register
...
floop:	SUBC(R3, 1, R21)
		...
		LD(R15, R22, R16) // element array[storeIndex]
...
quicksort:
		...
		// TO HOLD R22 RETURN VALUE PIVOTINDEX FROM partition procedure call
		PUSH(R7)
		...
		// the R22 will hold the pivotIndex value
